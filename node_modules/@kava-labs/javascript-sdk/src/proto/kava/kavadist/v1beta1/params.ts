    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.infrastructureParams = InfrastructureParams.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): Params {
    return {
      ...
      infrastructureParams: isSet(object.infrastructureParams)
        ? InfrastructureParams.fromJSON(object.infrastructureParams)
        : undefined,
    };
  },
  ...
  toJSON(message: Params): unknown {
    ...
    message.infrastructureParams !== undefined &&
      (obj.infrastructureParams = message.infrastructureParams
        ? InfrastructureParams.toJSON(message.infrastructureParams)
        : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    message.infrastructureParams =
      ...
      object.infrastructureParams !== null
        ? InfrastructureParams.fromPartial(object.infrastructureParams)
        : undefined;
    return message;
  },
};
...
export const InfrastructureParams = {
  ...
  decode(
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.infrastructurePeriods.push(
        ...
        case 2:
          ...
          break;
        case 3:
          message.partnerRewards.push(
            PartnerReward.decode(reader, reader.uint32())
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  fromJSON(object: any): InfrastructureParams {
    return {
      infrastructurePeriods: Array.isArray(object?.infrastructurePeriods)
        ? object.infrastructurePeriods.map((e: any) => Period.fromJSON(e))
        : [],
      coreRewards: Array.isArray(object?.coreRewards)
        ? object.coreRewards.map((e: any) => CoreReward.fromJSON(e))
        : [],
      partnerRewards: Array.isArray(object?.partnerRewards)
        ? object.partnerRewards.map((e: any) => PartnerReward.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: InfrastructureParams): unknown {
    ...
    if (message.infrastructurePeriods) {
      obj.infrastructurePeriods = message.infrastructurePeriods.map((e) =>
        e ? Period.toJSON(e) : undefined
      );
    } else {
    ...
    if (message.coreRewards) {
      obj.coreRewards = message.coreRewards.map((e) =>
        e ? CoreReward.toJSON(e) : undefined
      );
    } else {
      obj.coreRewards = [];
    }
    if (message.partnerRewards) {
      obj.partnerRewards = message.partnerRewards.map((e) =>
        e ? PartnerReward.toJSON(e) : undefined
      );
    } else {
      obj.partnerRewards = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<InfrastructureParams>, I>>(
    object: I
  ): InfrastructureParams {
    const message = createBaseInfrastructureParams();
    message.infrastructurePeriods =
      object.infrastructurePeriods?.map((e) => Period.fromPartial(e)) || [];
    message.coreRewards =
      object.coreRewards?.map((e) => CoreReward.fromPartial(e)) || [];
    message.partnerRewards =
      object.partnerRewards?.map((e) => PartnerReward.fromPartial(e)) || [];
    return message;
  },
};
...
export const CoreReward = {
  ...
  fromPartial<I extends Exact<DeepPartial<CoreReward>, I>>(
    object: I
  ): CoreReward {
    const message = createBaseCoreReward();
...
export const PartnerReward = {
  ...
  fromPartial<I extends Exact<DeepPartial<PartnerReward>, I>>(
    object: I
  ): PartnerReward {
    const message = createBasePartnerReward();
    message.address = object.address ?? new Uint8Array();
