...
function createBaseMsgConvertCoinToERC20(): MsgConvertCoinToERC20 {
  return { initiator: '', receiver: '', amount: undefined };
}
...
export const MsgConvertCoinToERC20 = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgConvertCoinToERC20>, I>>(
    object: I
  ): MsgConvertCoinToERC20 {
    const message = createBaseMsgConvertCoinToERC20();
...
export const MsgConvertCoinToERC20Response = {
  encode(
    _: MsgConvertCoinToERC20Response,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer;
  },
...
function createBaseMsgConvertERC20ToCoin(): MsgConvertERC20ToCoin {
  return { initiator: '', receiver: '', kavaErc20Address: '', amount: '' };
}
...
export const MsgConvertERC20ToCoin = {
  ...
  fromJSON(object: any): MsgConvertERC20ToCoin {
    return {
      initiator: isSet(object.initiator) ? String(object.initiator) : '',
      receiver: isSet(object.receiver) ? String(object.receiver) : '',
      kavaErc20Address: isSet(object.kavaErc20Address)
        ? String(object.kavaErc20Address)
        : '',
  ...
  toJSON(message: MsgConvertERC20ToCoin): unknown {
    ...
    message.initiator !== undefined && (obj.initiator = message.initiator);
    message.receiver !== undefined && (obj.receiver = message.receiver);
    message.kavaErc20Address !== undefined &&
      (obj.kavaErc20Address = message.kavaErc20Address);
    message.amount !== undefined && (obj.amount = message.amount);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<MsgConvertERC20ToCoin>, I>>(
    object: I
  ): MsgConvertERC20ToCoin {
    const message = createBaseMsgConvertERC20ToCoin();
    message.initiator = object.initiator ?? '';
...
export const MsgConvertERC20ToCoinResponse = {
  encode(
    _: MsgConvertERC20ToCoinResponse,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer;
  },
...
export class MsgClientImpl implements Msg {
  ...
  ConvertCoinToERC20(
    ...
    const promise = this.rpc.request(
      'kava.evmutil.v1beta1.Msg',
      'ConvertCoinToERC20',
      data
    );
    return promise.then((data) =>
      MsgConvertCoinToERC20Response.decode(new _m0.Reader(data))
    );
  }
  ...
  ConvertERC20ToCoin(
    ...
    return promise.then((data) =>
      MsgConvertERC20ToCoinResponse.decode(new _m0.Reader(data))
    );
  }
}
