...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.vaultRecords.push(
            VaultRecord.decode(reader, reader.uint32())
          );
          break;
        case 3:
          message.vaultShareRecords.push(
            VaultShareRecord.decode(reader, reader.uint32())
          );
          break;
        default:
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      vaultRecords: Array.isArray(object?.vaultRecords)
        ? object.vaultRecords.map((e: any) => VaultRecord.fromJSON(e))
        : [],
      vaultShareRecords: Array.isArray(object?.vaultShareRecords)
        ? object.vaultShareRecords.map((e: any) => VaultShareRecord.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.vaultRecords) {
      obj.vaultRecords = message.vaultRecords.map((e) =>
        e ? VaultRecord.toJSON(e) : undefined
      );
    } else {
      obj.vaultRecords = [];
    }
    if (message.vaultShareRecords) {
      obj.vaultShareRecords = message.vaultShareRecords.map((e) =>
        e ? VaultShareRecord.toJSON(e) : undefined
      );
    } else {
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(
    ...
    message.vaultRecords =
      object.vaultRecords?.map((e) => VaultRecord.fromPartial(e)) || [];
    message.vaultShareRecords =
      object.vaultShareRecords?.map((e) => VaultShareRecord.fromPartial(e)) ||
      [];
    return message;
  },
};
