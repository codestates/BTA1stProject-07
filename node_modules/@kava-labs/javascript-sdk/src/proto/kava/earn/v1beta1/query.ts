...
export const QueryVaultsResponse = {
  ...
  fromJSON(object: any): QueryVaultsResponse {
    return {
      vaults: Array.isArray(object?.vaults)
        ? object.vaults.map((e: any) => VaultResponse.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: QueryVaultsResponse): unknown {
    ...
    if (message.vaults) {
      obj.vaults = message.vaults.map((e) =>
        e ? VaultResponse.toJSON(e) : undefined
      );
    } else {
      obj.vaults = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<QueryVaultsResponse>, I>>(
    ...
    const message = createBaseQueryVaultsResponse();
    message.vaults =
      object.vaults?.map((e) => VaultResponse.fromPartial(e)) || [];
    return message;
  },
};
  ...
  fromJSON(object: any): QueryVaultResponse {
    return {
      vault: isSet(object.vault)
        ? VaultResponse.fromJSON(object.vault)
        : undefined,
    };
  },
  ...
  toJSON(message: QueryVaultResponse): unknown {
    ...
    message.vault !== undefined &&
      (obj.vault = message.vault
        ? VaultResponse.toJSON(message.vault)
        : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QueryVaultResponse>, I>>(
    ...
    message.vault =
      object.vault !== undefined && object.vault !== null
        ? VaultResponse.fromPartial(object.vault)
        : undefined;
    return message;
  },
};
  ...
  fromJSON(object: any): VaultResponse {
    return {
      ...
      allowedDepositors: Array.isArray(object?.allowedDepositors)
        ? object.allowedDepositors.map((e: any) => String(e))
        : [],
  ...
  fromJSON(object: any): DepositResponse {
    return {
      ...
      value: Array.isArray(object?.value)
        ? object.value.map((e: any) => Coin.fromJSON(e))
        : [],
    };
  },
