...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10:
          ...
          break;
        case 11:
          message.savingsRewardState = GenesisRewardState.decode(
            reader,
            reader.uint32()
          );
          break;
        case 12:
          message.savingsClaims.push(
            SavingsClaim.decode(reader, reader.uint32())
          );
          break;
        case 13:
          message.earnRewardState = GenesisRewardState.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      earnRewardState: isSet(object.earnRewardState)
        ? GenesisRewardState.fromJSON(object.earnRewardState)
        : undefined,
      earnClaims: Array.isArray(object?.earnClaims)
        ? object.earnClaims.map((e: any) => EarnClaim.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.savingsClaims) {
      obj.savingsClaims = message.savingsClaims.map((e) =>
        e ? SavingsClaim.toJSON(e) : undefined
      );
    } else {
      obj.savingsClaims = [];
    }
    message.earnRewardState !== undefined &&
      (obj.earnRewardState = message.earnRewardState
        ? GenesisRewardState.toJSON(message.earnRewardState)
        : undefined);
    if (message.earnClaims) {
      obj.earnClaims = message.earnClaims.map((e) =>
        e ? EarnClaim.toJSON(e) : undefined
      );
    } else {
      obj.earnClaims = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(
    ...
    message.savingsClaims =
      object.savingsClaims?.map((e) => SavingsClaim.fromPartial(e)) || [];
    message.earnRewardState =
      object.earnRewardState !== undefined && object.earnRewardState !== null
        ? GenesisRewardState.fromPartial(object.earnRewardState)
        : undefined;
    message.earnClaims =
      object.earnClaims?.map((e) => EarnClaim.fromPartial(e)) || [];
    return message;
  },
};
