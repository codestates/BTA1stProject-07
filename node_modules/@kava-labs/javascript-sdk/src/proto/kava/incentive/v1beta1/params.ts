...
export const Params = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          break;
        case 8:
          message.savingsRewardPeriods.push(
            MultiRewardPeriod.decode(reader, reader.uint32())
          );
          break;
        case 9:
          message.earnRewardPeriods.push(
            MultiRewardPeriod.decode(reader, reader.uint32())
          );
          break;
        default:
  ...
  fromJSON(object: any): Params {
    return {
      ...
      savingsRewardPeriods: Array.isArray(object?.savingsRewardPeriods)
        ? object.savingsRewardPeriods.map((e: any) =>
            MultiRewardPeriod.fromJSON(e)
          )
        : [],
      earnRewardPeriods: Array.isArray(object?.earnRewardPeriods)
        ? object.earnRewardPeriods.map((e: any) =>
            MultiRewardPeriod.fromJSON(e)
          )
        : [],
    };
  ...
  toJSON(message: Params): unknown {
    ...
    if (message.savingsRewardPeriods) {
      obj.savingsRewardPeriods = message.savingsRewardPeriods.map((e) =>
        e ? MultiRewardPeriod.toJSON(e) : undefined
      );
    } else {
    ...
    if (message.earnRewardPeriods) {
      obj.earnRewardPeriods = message.earnRewardPeriods.map((e) =>
        e ? MultiRewardPeriod.toJSON(e) : undefined
      );
    } else {
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    message.savingsRewardPeriods =
      object.savingsRewardPeriods?.map((e) =>
        MultiRewardPeriod.fromPartial(e)
      ) || [];
    message.earnRewardPeriods =
      object.earnRewardPeriods?.map((e) => MultiRewardPeriod.fromPartial(e)) ||
      [];
    return message;
  },
};
