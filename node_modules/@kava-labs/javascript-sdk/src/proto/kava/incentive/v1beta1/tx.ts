...
export const MsgClaimSavingsReward = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgClaimSavingsReward>, I>>(
    object: I
  ): MsgClaimSavingsReward {
    const message = createBaseMsgClaimSavingsReward();
    message.sender = object.sender ?? '';
...
export const MsgClaimSavingsRewardResponse = {
  encode(
    _: MsgClaimSavingsRewardResponse,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<MsgClaimSavingsRewardResponse>, I>>(
    _: I
  ): MsgClaimSavingsRewardResponse {
    const message = createBaseMsgClaimSavingsRewardResponse();
    return message;
...
export const MsgClaimEarnReward = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgClaimEarnReward>, I>>(
    object: I
  ): MsgClaimEarnReward {
    const message = createBaseMsgClaimEarnReward();
    message.sender = object.sender ?? '';
...
export const MsgClaimEarnRewardResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgClaimEarnRewardResponse>, I>>(
    _: I
  ): MsgClaimEarnRewardResponse {
    const message = createBaseMsgClaimEarnRewardResponse();
    return message;
...
export class MsgClientImpl implements Msg {
  ...
  ClaimSavingsReward(
    ...
    return promise.then((data) =>
      MsgClaimSavingsRewardResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  ClaimEarnReward(
    ...
    return promise.then((data) =>
      MsgClaimEarnRewardResponse.decode(new _m0.Reader(data))
    );
  }
}
