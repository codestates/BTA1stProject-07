...
var MsgClientImpl = /** @class */ (function () {
    ...
    MsgClientImpl.prototype.GrantAllowance = function (request) {
        ...
        return promise.then(function (data) {
            return exports.MsgGrantAllowanceResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    MsgClientImpl.prototype.RevokeAllowance = function (request) {
        ...
        return promise.then(function (data) {
            return exports.MsgRevokeAllowanceResponse.decode(new minimal_1.default.Reader(data));
        });
    };
