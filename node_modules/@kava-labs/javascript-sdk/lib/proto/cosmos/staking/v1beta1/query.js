...
exports.QueryValidatorsResponse = {
    ...
    fromJSON: function (object) {
        return {
            validators: Array.isArray(object === null || object === void 0 ? void 0 : object.validators)
                ? object.validators.map(function (e) { return staking_1.Validator.fromJSON(e); })
                : [],
            pagination: isSet(object.pagination)
    ...
    fromPartial: function (object) {
        ...
        var message = createBaseQueryValidatorsResponse();
        message.validators =
            ((_a = object.validators) === null || _a === void 0 ? void 0 : _a.map(function (e) { return staking_1.Validator.fromPartial(e); })) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
        ...
        return {
            delegationResponses: Array.isArray(object === null || object === void 0 ? void 0 : object.delegationResponses)
                ? object.delegationResponses.map(function (e) {
                    return staking_1.DelegationResponse.fromJSON(e);
                })
                : [],
            pagination: isSet(object.pagination)
                ? pagination_1.PageResponse.fromJSON(object.pagination)
    ...
    fromPartial: function (object) {
        ...
        message.delegationResponses =
            ((_a = object.delegationResponses) === null || _a === void 0 ? void 0 : _a.map(function (e) {
                return staking_1.DelegationResponse.fromPartial(e);
            })) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
                ? pagination_1.PageResponse.fromPartial(object.pagination)
        ...
        return {
            unbondingResponses: Array.isArray(object === null || object === void 0 ? void 0 : object.unbondingResponses)
                ? object.unbondingResponses.map(function (e) {
                    return staking_1.UnbondingDelegation.fromJSON(e);
                })
                : [],
            pagination: isSet(object.pagination)
                ? pagination_1.PageResponse.fromJSON(object.pagination)
    ...
    fromPartial: function (object) {
        ...
        message.unbondingResponses =
            ((_a = object.unbondingResponses) === null || _a === void 0 ? void 0 : _a.map(function (e) {
                return staking_1.UnbondingDelegation.fromPartial(e);
            })) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
                ? pagination_1.PageResponse.fromPartial(object.pagination)
        ...
        return {
            redelegationResponses: Array.isArray(object === null || object === void 0 ? void 0 : object.redelegationResponses)
                ? object.redelegationResponses.map(function (e) {
                    return staking_1.RedelegationResponse.fromJSON(e);
                })
                : [],
            pagination: isSet(object.pagination)
                ? pagination_1.PageResponse.fromJSON(object.pagination)
    ...
    fromPartial: function (object) {
        ...
        message.redelegationResponses =
            ((_a = object.redelegationResponses) === null || _a === void 0 ? void 0 : _a.map(function (e) {
                return staking_1.RedelegationResponse.fromPartial(e);
            })) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
                ? pagination_1.PageResponse.fromPartial(object.pagination)
...
var QueryClientImpl = /** @class */ (function () {
    ...
    QueryClientImpl.prototype.Validators = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryValidatorsResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    ...
    QueryClientImpl.prototype.ValidatorDelegations = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryValidatorDelegationsResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    QueryClientImpl.prototype.ValidatorUnbondingDelegations = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryValidatorUnbondingDelegationsResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    QueryClientImpl.prototype.Delegation = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryDelegationResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    QueryClientImpl.prototype.UnbondingDelegation = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryUnbondingDelegationResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    QueryClientImpl.prototype.DelegatorDelegations = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryDelegatorDelegationsResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    QueryClientImpl.prototype.DelegatorUnbondingDelegations = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryDelegatorUnbondingDelegationsResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    QueryClientImpl.prototype.Redelegations = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryRedelegationsResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    QueryClientImpl.prototype.DelegatorValidators = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryDelegatorValidatorsResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    QueryClientImpl.prototype.DelegatorValidator = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryDelegatorValidatorResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    QueryClientImpl.prototype.HistoricalInfo = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryHistoricalInfoResponse.decode(new minimal_1.default.Reader(data));
        });
    };
