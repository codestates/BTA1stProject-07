    ...
    fromJSON: function (object) {
        return {
            ...
            valset: Array.isArray(object === null || object === void 0 ? void 0 : object.valset)
                ? object.valset.map(function (e) { return exports.Validator.fromJSON(e); })
                : [],
        };
    },
    ...
    fromJSON: function (object) {
        return {
            pairs: Array.isArray(object === null || object === void 0 ? void 0 : object.pairs)
                ? object.pairs.map(function (e) { return exports.DVPair.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
...
exports.DVVTriplets = {
    ...
    fromJSON: function (object) {
        return {
            triplets: Array.isArray(object === null || object === void 0 ? void 0 : object.triplets)
                ? object.triplets.map(function (e) { return exports.DVVTriplet.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
    ...
    fromPartial: function (object) {
        ...
        var message = createBaseDVVTriplets();
        message.triplets =
            ((_a = object.triplets) === null || _a === void 0 ? void 0 : _a.map(function (e) { return exports.DVVTriplet.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.UnbondingDelegation = {
    ...
    fromPartial: function (object) {
        ...
        message.validatorAddress = (_b = object.validatorAddress) !== null && _b !== void 0 ? _b : '';
        message.entries =
            ((_c = object.entries) === null || _c === void 0 ? void 0 : _c.map(function (e) { return exports.UnbondingDelegationEntry.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.Redelegation = {
    ...
    fromJSON: function (object) {
        return {
            ...
            validatorDstAddress: isSet(object.validatorDstAddress)
                ...
                : '',
            entries: Array.isArray(object === null || object === void 0 ? void 0 : object.entries)
                ? object.entries.map(function (e) { return exports.RedelegationEntry.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
    ...
    fromPartial: function (object) {
        ...
        message.validatorDstAddress = (_c = object.validatorDstAddress) !== null && _c !== void 0 ? _c : '';
        message.entries =
            ((_d = object.entries) === null || _d === void 0 ? void 0 : _d.map(function (e) { return exports.RedelegationEntry.fromPartial(e); })) || [];
        return message;
    },
};
    ...
    fromPartial: function (object) {
        ...
        message.redelegation =
            object.redelegation !== undefined && object.redelegation !== null
                ...
                : undefined;
        message.entries =
            ((_a = object.entries) === null || _a === void 0 ? void 0 : _a.map(function (e) { return exports.RedelegationEntryResponse.fromPartial(e); })) ||
                [];
        return message;
    },
};
