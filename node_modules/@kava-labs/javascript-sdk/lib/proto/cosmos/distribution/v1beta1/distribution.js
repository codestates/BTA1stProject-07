...
exports.ValidatorHistoricalRewards = {
    encode: function (message, writer) {
        ...
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        try {
            for (var _b = __values(message.cumulativeRewardRatio), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
    ...
    fromJSON: function (object) {
        return {
            cumulativeRewardRatio: Array.isArray(object === null || object === void 0 ? void 0 : object.cumulativeRewardRatio)
                ? object.cumulativeRewardRatio.map(function (e) { return coin_1.DecCoin.fromJSON(e); })
                : [],
    ...
    fromPartial: function (object) {
        ...
        message.cumulativeRewardRatio =
            ((_a = object.cumulativeRewardRatio) === null || _a === void 0 ? void 0 : _a.map(function (e) { return coin_1.DecCoin.fromPartial(e); })) || [];
    ...
    fromJSON: function (object) {
        return {
            rewards: Array.isArray(object === null || object === void 0 ? void 0 : object.rewards)
                ? object.rewards.map(function (e) { return coin_1.DecCoin.fromJSON(e); })
                : [],
            period: isSet(object.period)
                ? long_1.default.fromString(object.period)
...
exports.ValidatorAccumulatedCommission = {
    encode: function (message, writer) {
        ...
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        try {
            for (var _b = __values(message.commission), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
                coin_1.DecCoin.encode(v, writer.uint32(10).fork()).ldelim();
            }
        }
    ...
    fromJSON: function (object) {
        return {
            commission: Array.isArray(object === null || object === void 0 ? void 0 : object.commission)
                ? object.commission.map(function (e) { return coin_1.DecCoin.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
    ...
    fromPartial: function (object) {
        ...
        var message = createBaseValidatorAccumulatedCommission();
        message.commission =
            ((_a = object.commission) === null || _a === void 0 ? void 0 : _a.map(function (e) { return coin_1.DecCoin.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.ValidatorSlashEvents = {
    encode: function (message, writer) {
        ...
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        try {
            for (var _b = __values(message.validatorSlashEvents), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
...
exports.FeePool = {
    encode: function (message, writer) {
        ...
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        try {
            for (var _b = __values(message.communityPool), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
                coin_1.DecCoin.encode(v, writer.uint32(10).fork()).ldelim();
            }
        }
    ...
    fromJSON: function (object) {
        return {
            communityPool: Array.isArray(object === null || object === void 0 ? void 0 : object.communityPool)
                ? object.communityPool.map(function (e) { return coin_1.DecCoin.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
    ...
    fromPartial: function (object) {
        ...
        message.communityPool =
            ((_a = object.communityPool) === null || _a === void 0 ? void 0 : _a.map(function (e) { return coin_1.DecCoin.fromPartial(e); })) || [];
        return message;
    },
};
    ...
    fromJSON: function (object) {
        return {
            ...
            reward: Array.isArray(object === null || object === void 0 ? void 0 : object.reward)
                ? object.reward.map(function (e) { return coin_1.DecCoin.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
