...
export declare const QueryValidatorSlashesRequest: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["startingHeight"], keyof Long>, never>) | undefined;
        endingHeight?: string | number | (Long & {
            ...
            toUnsigned: () => Long;
            xor: (other: string | number | Long) => Long;
        } & Record<Exclude<keyof I["endingHeight"], keyof Long>, never>) | undefined;
        pagination?: ({
            key?: Uint8Array | undefined;
            offset?: string | number | Long | undefined;
            limit?: string | number | Long | undefined;
    ...
    fromPartial<I extends {
        ...
        slashes?: ({
            ...
            validatorPeriod?: string | number | (Long & {
                ...
                toUnsigned: () => Long;
                xor: (other: string | number | Long) => Long;
            } & Record<Exclude<keyof I["slashes"][number]["validatorPeriod"], keyof Long>, never>) | undefined;
            fraction?: string | undefined;
