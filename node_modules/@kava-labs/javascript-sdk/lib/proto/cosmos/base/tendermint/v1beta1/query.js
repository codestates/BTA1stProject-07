...
var ServiceClientImpl = /** @class */ (function () {
    ...
    ServiceClientImpl.prototype.GetNodeInfo = function (request) {
        ...
        return promise.then(function (data) {
            return exports.GetNodeInfoResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    ServiceClientImpl.prototype.GetSyncing = function (request) {
        ...
        return promise.then(function (data) {
            return exports.GetSyncingResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    ServiceClientImpl.prototype.GetLatestBlock = function (request) {
        ...
        return promise.then(function (data) {
            return exports.GetLatestBlockResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    ServiceClientImpl.prototype.GetBlockByHeight = function (request) {
        ...
        return promise.then(function (data) {
            return exports.GetBlockByHeightResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    ServiceClientImpl.prototype.GetLatestValidatorSet = function (request) {
        ...
        return promise.then(function (data) {
            return exports.GetLatestValidatorSetResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    ServiceClientImpl.prototype.GetValidatorSetByHeight = function (request) {
        ...
        return promise.then(function (data) {
            return exports.GetValidatorSetByHeightResponse.decode(new minimal_1.default.Reader(data));
        });
    };
