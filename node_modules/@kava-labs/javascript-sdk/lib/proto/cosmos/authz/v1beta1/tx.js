...
var authz_1 = require("../../../cosmos/authz/v1beta1/authz");
    ...
    fromJSON: function (object) {
        return {
            ...
            msgs: Array.isArray(object === null || object === void 0 ? void 0 : object.msgs)
                ? object.msgs.map(function (e) { return any_1.Any.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
...
var MsgClientImpl = /** @class */ (function () {
    ...
    MsgClientImpl.prototype.Grant = function (request) {
        ...
        return promise.then(function (data) {
            return exports.MsgGrantResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    ...
    MsgClientImpl.prototype.Revoke = function (request) {
        ...
        return promise.then(function (data) {
            return exports.MsgRevokeResponse.decode(new minimal_1.default.Reader(data));
        });
    };
