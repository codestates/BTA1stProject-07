...
exports.Params = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.sendEnabled), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
...
exports.Supply = {
    encode: function (message, writer) {
        ...
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        try {
            for (var _b = __values(message.total), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
    ...
    fromJSON: function (object) {
        return {
            total: Array.isArray(object === null || object === void 0 ? void 0 : object.total)
                ? object.total.map(function (e) { return coin_1.Coin.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
...
exports.DenomUnit = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.aliases), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
...
exports.Metadata = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.denomUnits), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
