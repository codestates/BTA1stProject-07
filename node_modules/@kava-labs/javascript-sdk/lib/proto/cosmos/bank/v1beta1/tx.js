...
exports.MsgMultiSend = {
    encode: function (message, writer) {
        ...
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        try {
            for (var _c = __values(message.inputs), _d = _c.next(); !_d.done; _d = _c.next()) {
                var v = _d.value;
        ...
        try {
            for (var _e = __values(message.outputs), _f = _e.next(); !_f.done; _f = _e.next()) {
                var v = _f.value;
    ...
    fromJSON: function (object) {
        return {
            inputs: Array.isArray(object === null || object === void 0 ? void 0 : object.inputs)
                ? object.inputs.map(function (e) { return bank_1.Input.fromJSON(e); })
                : [],
            outputs: Array.isArray(object === null || object === void 0 ? void 0 : object.outputs)
                ? object.outputs.map(function (e) { return bank_1.Output.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.outputs) {
            obj.outputs = message.outputs.map(function (e) {
                return e ? bank_1.Output.toJSON(e) : undefined;
            });
        }
        else {
            obj.outputs = [];
...
var MsgClientImpl = /** @class */ (function () {
    ...
    MsgClientImpl.prototype.MultiSend = function (request) {
        ...
        return promise.then(function (data) {
            return exports.MsgMultiSendResponse.decode(new minimal_1.default.Reader(data));
        });
    };
