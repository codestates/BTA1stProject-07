...
exports.LegacyAminoPubKey = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.publicKeys), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
    ...
    fromJSON: function (object) {
        return {
            ...
            publicKeys: Array.isArray(object === null || object === void 0 ? void 0 : object.publicKeys)
                ? object.publicKeys.map(function (e) { return any_1.Any.fromJSON(e); })
                : [],
        };
    },
    ...
    fromPartial: function (object) {
        ...
        message.publicKeys =
            ((_b = object.publicKeys) === null || _b === void 0 ? void 0 : _b.map(function (e) { return any_1.Any.fromPartial(e); })) || [];
        return message;
    },
};
