...
exports.QueryModuleVersionsResponse = {
    ...
    toJSON: function (message) {
        ...
        if (message.moduleVersions) {
            obj.moduleVersions = message.moduleVersions.map(function (e) {
                return e ? upgrade_1.ModuleVersion.toJSON(e) : undefined;
            });
        }
        else {
            obj.moduleVersions = [];
    ...
    fromPartial: function (object) {
        ...
        message.moduleVersions =
            ((_a = object.moduleVersions) === null || _a === void 0 ? void 0 : _a.map(function (e) { return upgrade_1.ModuleVersion.fromPartial(e); })) || [];
        return message;
    },
};
var QueryClientImpl = /** @class */ (function () {
    ...
    QueryClientImpl.prototype.CurrentPlan = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryCurrentPlanResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    QueryClientImpl.prototype.AppliedPlan = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryAppliedPlanResponse.decode(new minimal_1.default.Reader(data));
        });
    };
    ...
    QueryClientImpl.prototype.ModuleVersions = function (request) {
        ...
        return promise.then(function (data) {
            return exports.QueryModuleVersionsResponse.decode(new minimal_1.default.Reader(data));
        });
    };
