...
exports.GenesisState = {
    ...
    fromJSON: function (object) {
        return {
            accounts: Array.isArray(object === null || object === void 0 ? void 0 : object.accounts)
                ? object.accounts.map(function (e) { return exports.GenesisAccount.fromJSON(e); })
                : [],
    ...
    toJSON: function (message) {
        ...
        if (message.accounts) {
            obj.accounts = message.accounts.map(function (e) {
                return e ? exports.GenesisAccount.toJSON(e) : undefined;
            });
        }
        else {
            obj.accounts = [];
    ...
    fromPartial: function (object) {
        ...
        var message = createBaseGenesisState();
        message.accounts =
            ((_a = object.accounts) === null || _a === void 0 ? void 0 : _a.map(function (e) { return exports.GenesisAccount.fromPartial(e); })) || [];
        message.params =
...
exports.GenesisAccount = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.storage), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = createBaseGenesisAccount();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
    ...
    fromJSON: function (object) {
        return {
            ...
            storage: Array.isArray(object === null || object === void 0 ? void 0 : object.storage)
                ? object.storage.map(function (e) { return evm_1.State.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.storage) {
            obj.storage = message.storage.map(function (e) {
                return e ? evm_1.State.toJSON(e) : undefined;
            });
        }
        else {
            obj.storage = [];
    ...
    fromPartial: function (object) {
        ...
        message.storage = ((_c = object.storage) === null || _c === void 0 ? void 0 : _c.map(function (e) { return evm_1.State.fromPartial(e); })) || [];
        return message;
    },
};
