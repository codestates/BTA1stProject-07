    ...
    fromJSON: function (object) {
        return {
            ...
            path: Array.isArray(object === null || object === void 0 ? void 0 : object.path)
                ? object.path.map(function (e) { return exports.InnerOp.fromJSON(e); })
                : [],
        };
    },
    ...
    fromJSON: function (object) {
        return {
            childOrder: Array.isArray(object === null || object === void 0 ? void 0 : object.childOrder)
                ? object.childOrder.map(function (e) { return Number(e); })
                : [],
...
exports.BatchProof = {
    ...
    fromJSON: function (object) {
        return {
            entries: Array.isArray(object === null || object === void 0 ? void 0 : object.entries)
                ? object.entries.map(function (e) { return exports.BatchEntry.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
    ...
    fromPartial: function (object) {
        ...
        var message = createBaseBatchProof();
        message.entries =
            ((_a = object.entries) === null || _a === void 0 ? void 0 : _a.map(function (e) { return exports.BatchEntry.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.CompressedBatchProof = {
    ...
    fromJSON: function (object) {
        return {
            entries: Array.isArray(object === null || object === void 0 ? void 0 : object.entries)
                ? object.entries.map(function (e) { return exports.CompressedBatchEntry.fromJSON(e); })
                : [],
            lookupInners: Array.isArray(object === null || object === void 0 ? void 0 : object.lookupInners)
                ? object.lookupInners.map(function (e) { return exports.InnerOp.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
    ...
    fromPartial: function (object) {
        ...
        var message = createBaseCompressedBatchProof();
        message.entries =
            ((_a = object.entries) === null || _a === void 0 ? void 0 : _a.map(function (e) { return exports.CompressedBatchEntry.fromPartial(e); })) || [];
        message.lookupInners =
            ((_b = object.lookupInners) === null || _b === void 0 ? void 0 : _b.map(function (e) { return exports.InnerOp.fromPartial(e); })) || [];
        return message;
    },
};
