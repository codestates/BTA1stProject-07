...
var store_1 = require("../../../kava/savings/v1beta1/store");
    ...
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.deposits), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
                store_1.Deposit.encode(v, writer.uint32(18).fork()).ldelim();
            }
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    message.deposits.push(store_1.Deposit.decode(reader, reader.uint32()));
                    break;
                default:
    ...
    fromJSON: function (object) {
        return {
            ...
            deposits: Array.isArray(object === null || object === void 0 ? void 0 : object.deposits)
                ? object.deposits.map(function (e) { return store_1.Deposit.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.deposits) {
            obj.deposits = message.deposits.map(function (e) {
                return e ? store_1.Deposit.toJSON(e) : undefined;
            });
        }
        else {
            obj.deposits = [];
    ...
    fromPartial: function (object) {
        ...
        message.params =
            object.params !== undefined && object.params !== null
                ...
                : undefined;
        message.deposits =
            ((_a = object.deposits) === null || _a === void 0 ? void 0 : _a.map(function (e) { return store_1.Deposit.fromPartial(e); })) || [];
        return message;
    },
};
