...
exports.Deposit = exports.Params = exports.protobufPackage = void 0;
/* eslint-disable */
var long_1 = __importDefault(require("long"));
var minimal_1 = __importDefault(require("protobufjs/minimal"));
var coin_1 = require("../../../cosmos/base/v1beta1/coin");
exports.protobufPackage = 'kava.savings.v1beta1';
...
exports.Params = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.supportedDenoms), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
    ...
    fromJSON: function (object) {
        return {
            supportedDenoms: Array.isArray(object === null || object === void 0 ? void 0 : object.supportedDenoms)
                ? object.supportedDenoms.map(function (e) { return String(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.supportedDenoms) {
            obj.supportedDenoms = message.supportedDenoms.map(function (e) { return e; });
        }
        else {
            obj.supportedDenoms = [];
        }
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseParams();
        message.supportedDenoms = ((_a = object.supportedDenoms) === null || _a === void 0 ? void 0 : _a.map(function (e) { return e; })) || [];
        return message;
    },
};
