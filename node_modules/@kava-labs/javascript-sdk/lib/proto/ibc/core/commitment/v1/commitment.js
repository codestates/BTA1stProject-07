...
exports.MerkleProof = {
    ...
    fromJSON: function (object) {
        return {
            proofs: Array.isArray(object === null || object === void 0 ? void 0 : object.proofs)
                ? object.proofs.map(function (e) { return proofs_1.CommitmentProof.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
    ...
    fromPartial: function (object) {
        ...
        var message = createBaseMerkleProof();
        message.proofs =
            ((_a = object.proofs) === null || _a === void 0 ? void 0 : _a.map(function (e) { return proofs_1.CommitmentProof.fromPartial(e); })) || [];
        return message;
    },
};
