...
exports.QueryChannelsResponse = {
    ...
    fromJSON: function (object) {
        return {
            channels: Array.isArray(object === null || object === void 0 ? void 0 : object.channels)
                ? object.channels.map(function (e) { return channel_1.IdentifiedChannel.fromJSON(e); })
                : [],
            pagination: isSet(object.pagination)
    ...
    fromPartial: function (object) {
        ...
        var message = createBaseQueryChannelsResponse();
        message.channels =
            ((_a = object.channels) === null || _a === void 0 ? void 0 : _a.map(function (e) { return channel_1.IdentifiedChannel.fromPartial(e); })) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
...
exports.QueryPacketCommitmentsResponse = {
    ...
    fromPartial: function (object) {
        ...
        var message = createBaseQueryPacketCommitmentsResponse();
        message.commitments =
            ((_a = object.commitments) === null || _a === void 0 ? void 0 : _a.map(function (e) { return channel_1.PacketState.fromPartial(e); })) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
                ? pagination_1.PageResponse.fromPartial(object.pagination)
                : undefined;
    ...
    fromJSON: function (object) {
        return {
            ...
            packetCommitmentSequences: Array.isArray(object === null || object === void 0 ? void 0 : object.packetCommitmentSequences)
                ? object.packetCommitmentSequences.map(function (e) { return long_1.default.fromString(e); })
                : [],
        };
    },
    toJSON: function (message) {
...
exports.QueryPacketAcknowledgementsResponse = {
    ...
    fromPartial: function (object) {
        ...
        message.acknowledgements =
            ((_a = object.acknowledgements) === null || _a === void 0 ? void 0 : _a.map(function (e) { return channel_1.PacketState.fromPartial(e); })) || [];
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
                ? pagination_1.PageResponse.fromPartial(object.pagination)
                : undefined;
    ...
    fromJSON: function (object) {
        return {
            sequences: Array.isArray(object === null || object === void 0 ? void 0 : object.sequences)
                ? object.sequences.map(function (e) { return long_1.default.fromString(e); })
                : [],
            height: isSet(object.height) ? client_1.Height.fromJSON(object.height) : undefined,
        };
    },
    ...
    fromJSON: function (object) {
        return {
            ...
            packetAckSequences: Array.isArray(object === null || object === void 0 ? void 0 : object.packetAckSequences)
                ? object.packetAckSequences.map(function (e) { return long_1.default.fromString(e); })
                : [],
        };
    },
    toJSON: function (message) {
