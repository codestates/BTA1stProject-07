...
exports.GenesisState = {
    encode: function (message, writer) {
        ...
        try {
            for (var _c = __values(message.connections), _d = _c.next(); !_d.done; _d = _c.next()) {
                var v = _d.value;
        ...
        try {
            for (var _e = __values(message.clientConnectionPaths), _f = _e.next(); !_f.done; _f = _e.next()) {
                var v = _f.value;
        ...
        return {
            ...
            clientConnectionPaths: Array.isArray(object === null || object === void 0 ? void 0 : object.clientConnectionPaths)
                ? object.clientConnectionPaths.map(function (e) {
                    return connection_1.ConnectionPaths.fromJSON(e);
                })
                : [],
    ...
    fromPartial: function (object) {
        ...
        var message = createBaseGenesisState();
        message.connections =
            ((_a = object.connections) === null || _a === void 0 ? void 0 : _a.map(function (e) { return connection_1.IdentifiedConnection.fromPartial(e); })) || [];
        message.clientConnectionPaths =
            ((_b = object.clientConnectionPaths) === null || _b === void 0 ? void 0 : _b.map(function (e) {
                return connection_1.ConnectionPaths.fromPartial(e);
            })) || [];
