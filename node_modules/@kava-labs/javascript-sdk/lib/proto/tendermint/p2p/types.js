...
exports.ProtocolVersion = {
    ...
    fromJSON: function (object) {
        return {
            p2p: isSet(object.p2p) ? long_1.default.fromString(object.p2p) : long_1.default.UZERO,
            block: isSet(object.block) ? long_1.default.fromString(object.block) : long_1.default.UZERO,
            app: isSet(object.app) ? long_1.default.fromString(object.app) : long_1.default.UZERO,
        };
    },
    toJSON: function (message) {
        var obj = {};
        message.p2p !== undefined &&
            (obj.p2p = (message.p2p || long_1.default.UZERO).toString());
