...
exports.Proof = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.aunts), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
    ...
    fromJSON: function (object) {
        return {
            total: isSet(object.total) ? long_1.default.fromString(object.total) : long_1.default.ZERO,
            ...
            aunts: Array.isArray(object === null || object === void 0 ? void 0 : object.aunts)
                ? object.aunts.map(function (e) { return bytesFromBase64(e); })
                : [],
        };
    },
    ...
    fromJSON: function (object) {
        return {
            ops: Array.isArray(object === null || object === void 0 ? void 0 : object.ops)
                ? object.ops.map(function (e) { return exports.ProofOp.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
