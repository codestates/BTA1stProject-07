    ...
    fromPartial: function (object) {
        ...
        message.consensusParams =
            object.consensusParams !== undefined && object.consensusParams !== null
                ...
                : undefined;
        message.validators =
            ((_c = object.validators) === null || _c === void 0 ? void 0 : _c.map(function (e) { return exports.ValidatorUpdate.fromPartial(e); })) || [];
...
exports.RequestBeginBlock = {
    encode: function (message, writer) {
        ...
        try {
            for (var _b = __values(message.byzantineValidators), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
    ...
    fromJSON: function (object) {
        return {
            ...
            byzantineValidators: Array.isArray(object === null || object === void 0 ? void 0 : object.byzantineValidators)
                ? object.byzantineValidators.map(function (e) { return exports.Evidence.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
    ...
    fromPartial: function (object) {
        ...
        message.byzantineValidators =
            ((_b = object.byzantineValidators) === null || _b === void 0 ? void 0 : _b.map(function (e) { return exports.Evidence.fromPartial(e); })) || [];
        return message;
    },
};
    ...
    fromPartial: function (object) {
        ...
        message.consensusParams =
            object.consensusParams !== undefined && object.consensusParams !== null
                ...
                : undefined;
        message.validators =
            ((_a = object.validators) === null || _a === void 0 ? void 0 : _a.map(function (e) { return exports.ValidatorUpdate.fromPartial(e); })) || [];
...
exports.ResponseQuery = {
    ...
    fromJSON: function (object) {
        return {
            ...
            log: isSet(object.log) ? String(object.log) : '',
            info: isSet(object.info) ? String(object.info) : '',
            index: isSet(object.index) ? long_1.default.fromString(object.index) : long_1.default.ZERO,
    ...
    fromJSON: function (object) {
        return {
            events: Array.isArray(object === null || object === void 0 ? void 0 : object.events)
                ? object.events.map(function (e) { return exports.Event.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
...
exports.ResponseEndBlock = {
    ...
    fromPartial: function (object) {
        ...
        message.validatorUpdates =
            ((_a = object.validatorUpdates) === null || _a === void 0 ? void 0 : _a.map(function (e) { return exports.ValidatorUpdate.fromPartial(e); })) || [];
...
exports.ResponseListSnapshots = {
    ...
    fromJSON: function (object) {
        return {
            snapshots: Array.isArray(object === null || object === void 0 ? void 0 : object.snapshots)
                ? object.snapshots.map(function (e) { return exports.Snapshot.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
    ...
    fromPartial: function (object) {
        ...
        var message = createBaseResponseListSnapshots();
        message.snapshots =
            ((_a = object.snapshots) === null || _a === void 0 ? void 0 : _a.map(function (e) { return exports.Snapshot.fromPartial(e); })) || [];
        return message;
    },
};
    ...
    fromJSON: function (object) {
        return {
            ...
            refetchChunks: Array.isArray(object === null || object === void 0 ? void 0 : object.refetchChunks)
                ? object.refetchChunks.map(function (e) { return Number(e); })
                : [],
            rejectSenders: Array.isArray(object === null || object === void 0 ? void 0 : object.rejectSenders)
                ? object.rejectSenders.map(function (e) { return String(e); })
                : [],
        };
    },
    toJSON: function (message) {
    ...
    fromJSON: function (object) {
        return {
            maxBytes: isSet(object.maxBytes)
                ...
                : long_1.default.ZERO,
            maxGas: isSet(object.maxGas) ? long_1.default.fromString(object.maxGas) : long_1.default.ZERO,
        };
    },
    toJSON: function (message) {
        var obj = {};
    ...
    fromJSON: function (object) {
        return {
            ...
            votes: Array.isArray(object === null || object === void 0 ? void 0 : object.votes)
                ? object.votes.map(function (e) { return exports.VoteInfo.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
...
exports.Event = {
    ...
    fromPartial: function (object) {
        ...
        message.attributes =
            ((_b = object.attributes) === null || _b === void 0 ? void 0 : _b.map(function (e) { return exports.EventAttribute.fromPartial(e); })) || [];
        return message;
    },
};
    ...
    fromJSON: function (object) {
        return {
            address: isSet(object.address)
                ...
                : new Uint8Array(),
            power: isSet(object.power) ? long_1.default.fromString(object.power) : long_1.default.ZERO,
        };
    },
    toJSON: function (message) {
        var obj = {};
