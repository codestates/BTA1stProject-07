...
var types_2 = require("../../tendermint/libs/bits/types");
    ...
    fromJSON: function (object) {
        return {
            ...
            secondsSinceStartTime: isSet(object.secondsSinceStartTime)
                ? long_1.default.fromString(object.secondsSinceStartTime)
                : long_1.default.ZERO,
...
exports.NewValidBlock = {
    encode: function (message, writer) {
        ...
        if (message.blockPartSetHeader !== undefined) {
            types_1.PartSetHeader.encode(message.blockPartSetHeader, writer.uint32(26).fork()).ldelim();
        }
        if (message.blockParts !== undefined) {
            types_2.BitArray.encode(message.blockParts, writer.uint32(34).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.blockPartSetHeader = types_1.PartSetHeader.decode(reader, reader.uint32());
                    break;
                case 4:
                    message.blockParts = types_2.BitArray.decode(reader, reader.uint32());
                    break;
                case 5:
    ...
    fromJSON: function (object) {
        return {
            ...
            blockPartSetHeader: isSet(object.blockPartSetHeader)
                ? types_1.PartSetHeader.fromJSON(object.blockPartSetHeader)
                : undefined,
            blockParts: isSet(object.blockParts)
                ? types_2.BitArray.fromJSON(object.blockParts)
                : undefined,
    ...
    toJSON: function (message) {
        ...
        message.blockPartSetHeader !== undefined &&
            (obj.blockPartSetHeader = message.blockPartSetHeader
                ? types_1.PartSetHeader.toJSON(message.blockPartSetHeader)
                : undefined);
        message.blockParts !== undefined &&
            (obj.blockParts = message.blockParts
                ? types_2.BitArray.toJSON(message.blockParts)
                : undefined);
    ...
    fromPartial: function (object) {
        ...
        message.blockPartSetHeader =
            object.blockPartSetHeader !== undefined &&
                ...
                ? types_1.PartSetHeader.fromPartial(object.blockPartSetHeader)
                : undefined;
        message.blockParts =
            object.blockParts !== undefined && object.blockParts !== null
                ? types_2.BitArray.fromPartial(object.blockParts)
                : undefined;
...
exports.ProposalPOL = {
    encode: function (message, writer) {
        ...
        if (message.proposalPol !== undefined) {
            types_2.BitArray.encode(message.proposalPol, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message.proposalPol = types_2.BitArray.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return {
            ...
            proposalPol: isSet(object.proposalPol)
                ? types_2.BitArray.fromJSON(object.proposalPol)
                : undefined,
        };
    },
    toJSON: function (message) {
        ...
        message.proposalPol !== undefined &&
            (obj.proposalPol = message.proposalPol
                ? types_2.BitArray.toJSON(message.proposalPol)
                : undefined);
        return obj;
    },
    fromPartial: function (object) {
        ...
        message.proposalPol =
            object.proposalPol !== undefined && object.proposalPol !== null
                ? types_2.BitArray.fromPartial(object.proposalPol)
                : undefined;
        return message;
    },
};
...
exports.VoteSetMaj23 = {
    encode: function (message, writer) {
        ...
        if (message.blockId !== undefined) {
            types_1.BlockID.encode(message.blockId, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
