...
export declare const BitArray: {
    ...
    fromPartial<I extends {
        ...
        } & Record<Exclude<keyof I["bits"], keyof Long>, never>) | undefined;
        elems?: ((string | number | Long)[] & (string | number | (Long & {
            ...
            toUnsigned: () => Long;
            xor: (other: string | number | Long) => Long;
        } & Record<Exclude<keyof I["elems"][number], keyof Long>, never>))[] & Record<Exclude<keyof I["elems"], keyof (string | number | Long)[]>, never>) | undefined;
