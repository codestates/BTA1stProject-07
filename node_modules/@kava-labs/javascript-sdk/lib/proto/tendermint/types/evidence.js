...
exports.LightClientAttackEvidence = {
    ...
    fromPartial: function (object) {
        ...
        message.byzantineValidators =
            ((_a = object.byzantineValidators) === null || _a === void 0 ? void 0 : _a.map(function (e) { return validator_1.Validator.fromPartial(e); })) || [];
        message.totalVotingPower =
            object.totalVotingPower !== undefined && object.totalVotingPower !== null
                ? long_1.default.fromValue(object.totalVotingPower)
                : long_1.default.ZERO;
...
exports.EvidenceList = {
    encode: function (message, writer) {
        ...
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        try {
            for (var _b = __values(message.evidence), _c = _b.next(); !_c.done; _c = _b.next()) {
                var v = _c.value;
