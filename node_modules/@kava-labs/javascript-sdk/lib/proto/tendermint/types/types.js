    ...
    fromJSON: function (object) {
        return {
            txs: Array.isArray(object === null || object === void 0 ? void 0 : object.txs)
                ? object.txs.map(function (e) { return bytesFromBase64(e); })
                : [],
        };
    },
    toJSON: function (message) {
    ...
    fromJSON: function (object) {
        return {
            ...
            signatures: Array.isArray(object === null || object === void 0 ? void 0 : object.signatures)
                ? object.signatures.map(function (e) { return exports.CommitSig.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
    ...
    fromPartial: function (object) {
        ...
        message.blockId =
            object.blockId !== undefined && object.blockId !== null
                ...
                : undefined;
        message.signatures =
            ((_b = object.signatures) === null || _b === void 0 ? void 0 : _b.map(function (e) { return exports.CommitSig.fromPartial(e); })) || [];
        return message;
    },
};
    ...
    fromJSON: function (object) {
        return {
            ...
            blockSize: isSet(object.blockSize)
                ...
                : long_1.default.ZERO,
            header: isSet(object.header) ? exports.Header.fromJSON(object.header) : undefined,
            numTxs: isSet(object.numTxs) ? long_1.default.fromString(object.numTxs) : long_1.default.ZERO,
        };
    },
    toJSON: function (message) {
        var obj = {};
